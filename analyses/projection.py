...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--fwd", default=None, help="Two-sentence run, O1=S4 / O2=P.")
    p.add_argument("--rev", default=None, help="Two-sentence run, O1=P / O2=S4.")
    p.add_argument("--slot", default=None, help="Carrier slot name (default from manifest).")
    p.add_argument("--para", default="S4", help="Carrier column at t=0.")
    p.add_argument("--infer", default="P", help="Carrier column at t=1.")
